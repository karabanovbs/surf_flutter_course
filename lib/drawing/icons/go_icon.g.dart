...
part of 'go_icon.dart';

// **************************************************************************
// SvgToPathGenerator
// **************************************************************************

// SvgToPath for res/svg/go.svg

// <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
// <path fill-rule="evenodd" clip-rule="evenodd" d="M22 4C22 5.65685 20.6569 7 19 7C17.6938 7 16.5825 6.16519 16.1707 5H7C5.34315 5 4 6.34315 4 8V8.25926C4 9.91611 5.34315 11.2593 7 11.2593H17.1296C19.8195 11.2593 22 13.4398 22 16.1296C22 18.8195 19.8195 21 17.1296 21H15.4142L15.7071 21.2929C16.0977 21.6834 16.0977 22.3166 15.7071 22.7071C15.3166 23.0976 14.6834 23.0976 14.2929 22.7071L11.5858 20L14.2929 17.2929C14.6834 16.9024 15.3166 16.9024 15.7071 17.2929C16.0977 17.6834 16.0977 18.3166 15.7071 18.7071L15.4142 19H17.1296C18.7149 19 20 17.7149 20 16.1296C20 14.5444 18.7149 13.2593 17.1296 13.2593H7C4.23858 13.2593 2 11.0207 2 8.25926V8C2 5.23858 4.23858 3 7 3H16.1707C16.5825 1.83481 17.6938 1 19 1C20.6569 1 22 2.34315 22 4ZM5 23C6.65685 23 8 21.6569 8 20C8 18.3431 6.65685 17 5 17C3.34315 17 2 18.3431 2 20C2 21.6569 3.34315 23 5 23Z" fill="white"/>
// </svg>
//
...
class _GoIconPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_GoIconPainter oldDelegate) => false;
}
